...
// Legacy alias kept so older CTA imports continue to work during the funnel transition.
export const CREATE_ACCOUNT_URL = process.env.NEXT_PUBLIC_CREATE_ACCOUNT_URL || WAITLIST_URL

export const DOCS_URL = process.env.NEXT_PUBLIC_DOCS_URL || 'https://docs.deploytitan.com'

// Public waitlist endpoint for direct browser submissions to Formspree.
export const FORM_ENDPOINT = process.env.NEXT_PUBLIC_FORM_ENDPOINT as string | undefined
...
export const STEALTH_PRODUCTS = process.env.NEXT_PUBLIC_STEALTH_PRODUCTS !== 'false'
