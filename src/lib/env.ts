...
export const CONSOLE_URL = process.env.NEXT_PUBLIC_CONSOLE_URL || 'https://console.deploytitan.com'
...
export const CREATE_ACCOUNT_URL =
  process.env.NEXT_PUBLIC_CREATE_ACCOUNT_URL || 'https://console.deploytitan.com'
