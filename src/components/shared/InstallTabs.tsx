          ...
          <button
            ...
            className={cn(
              ...
              active === t.id
                ...
                : 'bg-transparent text-muted hover:text-surface/80 hover:bg-white/[0.02]',
            )}
          >
            <span>{t.label}</span>
            <span className={cn('text-[10px] font-normal', active === t.id ? 'text-primary/70' : 'text-muted/60')}>{t.sublabel}</span>
          </button>
        ))}
      </div>
