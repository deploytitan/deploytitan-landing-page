    ...
    <section className="py-16 lg:py-20 border-t border-line relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 data-reveal data-reveal-delay="2" className="font-display font-medium text-4xl lg:text-6xl tracking-[-0.022em] leading-[1.08] mb-6">
            Make deployments<br />
            <span style={{ color: PRIMARY }}>boring</span>
            <span className="text-ink-secondary"> again.</span>
          </h2>

          <div data-reveal data-reveal-delay="3" className="space-y-3 text-lg text-ink leading-relaxed">
            <p>No late-night monitoring.</p>
            <p>No panic rollbacks.</p>
            <p>No hesitation before shipping.</p>
            <p className="font-medium text-ink">
              Just smooth, controlled releases—every time.
            </p>
          </div>

          {/* Quiet metrics */}
          <div data-reveal data-reveal-delay="4" className="mt-14 grid grid-cols-3 gap-3 max-w-sm mx-auto">
            {[
              ...
              >
                <div className="font-mono font-medium text-lg mb-0.5" style={{ color: PRIMARY }}>{m.value}</div>
                <div className="text-[10px] font-mono text-ink-tertiary uppercase tracking-wider">{m.label}</div>
              </div>
            ))}
          </div>
        </div>
