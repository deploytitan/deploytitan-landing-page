              ...
              {!submitted ? (
                ...
                >
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="w-full px-5 py-4 border border-line text-sm bg-white text-ink placeholder:text-ink-quaternary focus:outline-none focus:border-gold/40 transition-colors"
                    style={{ borderRadius: '2px' }}
                  />
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 bg-ink text-surface px-7 py-4 text-sm font-medium transition-all active:scale-[0.97] hover:shadow-[0_0_0_1px_rgba(201,168,76,0.3),0_2px_8px_rgba(0,0,0,0.08)]"
                    style={{ borderRadius: '2px' }}
                  >
                    Join the Waitlist
