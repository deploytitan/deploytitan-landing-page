  ...
  return (
    <section id="final-cta" className="py-16 lg:py-20 border-t border-line relative" ref={ref}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative">
        ...
        >
          {/* Extra corners */}
          <div className="absolute top-0 right-0 w-3 h-3 border-t border-r opacity-30" style={{ borderColor: 'var(--color-primary)' }} aria-hidden="true" />
          <div className="absolute bottom-0 left-0 w-3 h-3 border-b border-l opacity-30" style={{ borderColor: 'var(--color-primary)' }} aria-hidden="true" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-10 lg:p-16 border-b lg:border-b-0 lg:border-r border-line flex flex-col justify-center">
              <span data-reveal className="inline-flex items-center gap-3 text-sm font-mono text-ink-secondary mb-5">
                <span className="w-8 h-px bg-primary/40" />
                Live demo
              </span>

              <h2 data-reveal data-reveal-delay="1" className="font-display font-medium text-3xl lg:text-4xl tracking-[-0.022em] leading-[1.12] mb-4">
                Start shipping<br />without fear.
              </h2>

              <p data-reveal data-reveal-delay="2" className="text-base text-ink-secondary leading-relaxed mb-8 max-w-sm">
              ...
              {/* Trust signals */}
              <div data-reveal data-reveal-delay="4" className="mt-8 pt-6 border-t border-line space-y-3">
                {trustSignals.map((ts) => (
                  <div key={ts.label} className="flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={PRIMARY} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 opacity-60">
            ...
            <div className="p-10 lg:p-16 flex flex-col justify-center">
              ...
              <h3 data-reveal data-reveal-delay="2" className="font-display font-medium text-2xl lg:text-3xl tracking-[-0.02em] leading-[1.2] mb-3">
                Get notified when we launch self-serve.
              </h3>

              <p data-reveal data-reveal-delay="3" className="text-sm text-ink-secondary leading-relaxed mb-8 max-w-sm">
                We're working with a small group of teams to shape the product. Leave your email to stay in the loop.
              </p>
              ...
              {!submitted ? (
                ...
                >
                  ...
                  >
                    {submitting ? (
                      <>
                        <span className="w-3.5 h-3.5 border-2 border-ink/20 border-t-ink animate-spin" style={{ borderRadius: '50%' }} />
                        Submitting...
                      </>
                    ) : (
                      'Keep me updated'
                  ...
                  <p className="text-xs text-ink-tertiary font-mono text-center pt-1">No spam. Just product updates.</p>
                </form>
              ) : (
                <div data-reveal className="flex flex-col items-start gap-3 py-4">
                  ...
                  <p className="text-sm text-ink-secondary">We'll reach out when self-serve is ready.</p>
                </div>
              )}
              ...
              <div data-reveal data-reveal-delay="5" className="mt-8 pt-6 border-t border-line">
                <div className="flex items-center gap-3">
                  <div className="relative flex h-2 w-2">
                    <span className="absolute inline-flex h-full w-full bg-primary opacity-50" style={{ animation: 'ping-anim 2s cubic-bezier(0,0,0.2,1) infinite', borderRadius: '1px' }} />
                    <span className="relative inline-flex h-2 w-2 bg-primary" style={{ borderRadius: '1px' }} />
                  </div>
