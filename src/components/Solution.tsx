...
const capabilities = [
  {
    ...
    detail: 'Traffic stays on the last known-good version until you explicitly shift it. Nothing is overwritten.',
    icon: (
  ...
  },
  {
    ...
    detail: 'Route beta testers, internal users, or a percentage slice to the new version — independently of everyone else.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    detail: 'Define thresholds — error rate, latency, custom metrics. DeployTitan promotes or reverts traffic automatically when those thresholds breach. Not just on deploy.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    detail: 'Deploy to US during US business hours, EU during EU business hours — automatically. Policies respect geography and time, so your team is always awake when a rollout runs.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    detail: 'Monitor which version is serving which users, watch health signals live, and audit every automated action — all in one view.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    detail: 'Configure per-version error budgets, latency ceilings, and custom signal weights. Rollouts automatically pause or revert when limits are exceeded — no one needs to be watching.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section id="solution" className="py-16 lg:py-20 border-t border-line relative" ref={ref}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative">
        {/* Header */}
          ...
          <p data-reveal data-reveal-delay="2" className="text-lg text-ink-secondary leading-relaxed">
            DeployTitan gives your team real-time control over production—without redeploying. Detect issues as they happen, respond automatically or instantly, and keep systems stable under pressure.
          </p>
        </div>
          ...
          {capabilities.map((cap, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-display font-medium text-lg tracking-[-0.01em] mb-2">{cap.label}</h3>
