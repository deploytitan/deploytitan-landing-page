        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p data-reveal data-reveal-delay="2" className="text-lg text-ink-secondary leading-relaxed mb-8 max-w-lg">
              DeployTitan analyzes every change before it reaches production. Ship with confidence—not guesswork.
            </p>

            <div className="space-y-4">
              {[
                { label: 'Risk scoring on pull requests', detail: 'Every PR gets a risk signal before merge' },
                { label: 'Visibility into potential impact', detail: 'Understand blast radius before deploying' },
                { label: 'Better decisions before deployment', detail: 'Ship confidently, not hopefully' },
              ].map((item, i) => (
                <div
                  key={item.label}
                  data-reveal
          ...
          <div data-reveal data-reveal-delay="6">
            ...
            >
              ...
              <p className="text-[10px] font-mono uppercase tracking-[0.1em] mb-5 text-ink-quaternary">PR risk analysis</p>

              {[
                { pr: '#1842 — refactor auth flow', risk: 'High', riskColor: '#ef4444', services: '3 services affected' },
                { pr: '#1843 — update API timeout', risk: 'Medium', riskColor: '#f59e0b', services: '1 service affected' },
                { pr: '#1844 — fix typo in copy', risk: 'Low', riskColor: '#22c55e', services: 'No services affected' },
              ].map((item) => (
                <div
                  key={item.pr}
              ...
              <div className="mt-4 flex items-center gap-2">
                <div className="w-1.5 h-1.5" style={{ backgroundColor: `${PRIMARY_RGBA},0.5)`, borderRadius: '0.5px' }} />
                <span className="text-[10px] font-mono text-ink-tertiary">Analyzed before merge · updated on each push</span>
              </div>
            </div>
          </div>
        </div>
