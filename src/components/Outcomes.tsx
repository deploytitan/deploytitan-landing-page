...
const outcomes: Outcome[] = [
  {
    ...
    description:
      'Gradual rollouts and policy-based rollbacks catch bad releases before they affect every user. Most issues get contained before they scale.',
  ...
  },
  {
    ...
    description:
      'Every version is addressable. Every rollout is shaped. Traffic shifts are explicit, not accidental.',
  ...
  },
  {
    ...
    description:
      'When rollback is instant and rollouts are gradual, teams stop delaying releases out of fear. They ship more, more often.',
...
export function Outcomes() {
  ...
  return (
    <Section id="outcomes" border="top" padding="lg" tone="muted" className="relative">
      <div ref={ref} className="contents">
        ...
        <Container className="relative">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start gap-6">
                  ...
                  <div className="flex-shrink-0 flex flex-col items-center sm:items-start">
                    ...
                    <div
                      className="font-display font-medium text-5xl lg:text-6xl tracking-[-0.03em] leading-none"
                      style={{ color: PRIMARY }}
                    >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div
                          className="h-2 w-full bg-surface-alt border border-line overflow-hidden"
                          style={{ borderRadius: '1px' }}
                        >
                          <div
                            className="h-full bg-ink-quaternary/30"
                            style={{ width: `${o.beforeBarPercent ?? 35}%`, borderRadius: '1px' }}
                          />
                        </div>
                      </div>
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-[10px] font-mono uppercase tracking-[0.06em] text-ink-secondary">
                            With Titan
                          </span>
                          <span className="text-[10px] font-mono" style={{ color: o.barColor }}>
                            {o.afterValue}
                          </span>
                        </div>
                        <div
          ...
          <div
            data-reveal
            data-reveal-delay="7"
            className="mt-8 border border-line bg-surface px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4"
            style={{ borderRadius: '2px' }}
          >
