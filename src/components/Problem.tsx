...
export function Problem() {
  ...
  return (
    <Section id="problem" border="top" padding="lg" className="relative">
      <div ref={ref} className="contents">
        {/* Subtle blueprint grid background */}
        <div
          className="absolute inset-0 blueprint-grid opacity-40 pointer-events-none"
          aria-hidden="true"
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p
                data-reveal
                data-reveal-delay="2"
                className="text-lg text-ink-secondary leading-relaxed mb-10 max-w-lg"
              >
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-ink leading-relaxed">
                    So teams slow down… just to stay safe. Every release feels heavier than the
                    last.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 pt-6 border-t border-line">
                  {[
                    ...
                    >
                      <div
                        className="text-lg font-mono font-medium mb-1"
