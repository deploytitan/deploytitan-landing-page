...
const points = [
  ...
  { label: 'Routing decisions served from memory', detail: 'No external API calls during execution' },
    ...
    <section className="py-16 lg:py-20 border-t border-line relative" ref={ref}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p data-reveal data-reveal-delay="2" className="text-lg text-ink-secondary leading-relaxed mb-10 max-w-xl mx-auto">
            DeployTitan runs outside your request path—so your performance stays untouched. Your p99 stays exactly where it should be.
          </p>

          <div data-reveal data-reveal-delay="3" className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
            {points.map((p) => (
              <div
                key={p.label}
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={PRIMARY} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="opacity-70 shrink-0">
