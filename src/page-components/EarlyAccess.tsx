...
export default function EarlyAccess() {  useScrollReveal()
    ...
    <>
      ...
      <section className="blueprint-grid pt-28 pb-20 border-b border-line">
        <Container width="4xl" padding="default" className="text-center" data-reveal>
          <div
            className="inline-flex items-center gap-2 font-mono text-[10px] text-primary border border-primary/30 px-3 py-1.5 mb-6"
          ...
          <h1 className="text-4xl lg:text-5xl font-semibold text-ink leading-tight mb-5">
            Become a DeployTitan
            <br className="hidden md:block" /> design partner.
          </h1>
          <p className="text-lg text-ink-secondary leading-relaxed max-w-2xl mx-auto">
            We're working closely with a small cohort of engineering teams to shape the product. You
            get white-glove onboarding, direct access to our team, and locked-in pricing — forever.
          </p>
        </Container>
      </section>
        ...
        <Container width="5xl" padding="default">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {PARTNER_BENEFITS.map((b, i) => (
              <Card
                key={b.title}
                className="flex gap-4 hover:border-primary/20 transition-all"
                data-reveal
          ...
          {form.submitted ? (
            <div className="text-center py-16" data-reveal>
              ...
              <p className="text-ink-secondary text-sm leading-relaxed max-w-md mx-auto">
                We review every application personally. You'll hear back from us within 2 business
                days. In the meantime, check out the{' '}
                <a href="/docs" className="text-primary hover:text-primary-dark">
                  documentation
                </a>{' '}
                or explore the{' '}
                <a href="/products/titan-rollout" className="text-primary hover:text-primary-dark">
                  product pages
                </a>
                .
              </p>
            ...
            <>
              <div className="mb-10" data-reveal>
                ...
                <p className="text-sm text-ink-secondary">
                  We review every application personally. Tell us about your stack and biggest
                  deploy pain.
                </p>
              </div>
              <form onSubmit={handleSubmit} className="flex flex-col gap-5" data-reveal>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono text-ink-secondary uppercase tracking-wider">
                      Your name <span className="text-signal-danger">*</span>
                    </label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono text-ink-secondary uppercase tracking-wider">
                      Work email <span className="text-signal-danger">*</span>
                    </label>
                    <input
                      required
                      type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono text-ink-secondary uppercase tracking-wider">
                      Company <span className="text-signal-danger">*</span>
                    </label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-mono text-ink-secondary uppercase tracking-wider">
                      Your role <span className="text-signal-danger">*</span>
                    </label>
                    <select
                      required
                      value={form.role}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-mono text-ink-secondary uppercase tracking-wider">
                    Primary infrastructure <span className="text-signal-danger">*</span>
                  </label>
                  <select
                    required
                    value={form.infra}
