      ...
      <section className="py-24 border-t border-line">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-12" data-reveal>
            ...
            <h2 className="text-2xl lg:text-3xl font-semibold text-ink mb-3">Risk scoring in your CI pipeline in 5 minutes.</h2>
            <p className="text-ink-secondary max-w-xl">Add one GitHub Actions step. Get risk scores, blast-radius maps, and SLO impact reports on every PR — automatically.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8" data-reveal>
            <div className="flex flex-col gap-6">
              <div>
                <p className="text-xs font-mono text-ink-tertiary uppercase tracking-wider mb-3">Install CLI</p>
                <InstallTabs />
              </div>
              <div>
                <p className="text-xs font-mono text-ink-tertiary uppercase tracking-wider mb-3">CLI risk check</p>
                <CodeBlock code={CLI_CODE} lang="bash" filename="terminal" />
              </div>
            </div>
            <div>
              <p className="text-xs font-mono text-ink-tertiary uppercase tracking-wider mb-3">GitHub Actions integration</p>
