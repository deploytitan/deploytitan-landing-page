...
const CROSS_LINKS = [
  {
    label: 'Titan Rollout',
    desc: 'Progressive deployments & rollback',
      ...
      <section className="blueprint-grid pt-28 pb-20 border-b border-line">
        <div className="max-w-4xl mx-auto px-6" data-reveal>
          ...
          <h1 className="text-4xl lg:text-5xl font-semibold text-ink leading-tight mb-6">
            ...
            <br className="hidden md:block" /> See everything, miss nothing.
          </h1>
          <p className="text-lg text-ink-secondary leading-relaxed max-w-2xl mb-8">
            Titan Pulse turns every deploy into structured telemetry — giving engineering teams
            real-time dashboards, automatic DORA metrics, and the historical signal to ship faster
            with confidence.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div data-reveal>
              ...
              <p className="text-ink-secondary leading-relaxed mb-6">
                Titan Pulse is built directly into the DeployTitan controller. Every deploy stage —
                canary start, health check, traffic shift, rollback — emits structured events
                automatically. There's nothing to wire up.
              </p>
            ...
            {/* Diagram — keep raw: bg-ink (dark background) */}
            <div className="sharp-card border border-line p-6 bg-ink" data-reveal>
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  {
                    label: 'Pulse Event Bus',
                    sub: 'Structured deploy events',
                    color: 'text-primary',
                  },
                  {
                    label: 'Dashboard · DORA · Alerts',
                    sub: 'Your observability stack',
                    color: 'text-surface/80',
                  },
                ].map((row, i) => (
                  <div key={row.label}>
      ...
      <section className="py-24 border-b border-line bg-surface-alt/20">
        <Container width="6xl" padding="default">
          <div className="mb-10" data-reveal>
            ...
            <p className="text-ink-secondary max-w-xl">
              The four DORA metrics are computed from real deploy events — no spreadsheets, no
              retros, no guessing.
            </p>
            <div className="mt-2">
              <RoadmapBadge variant="preview" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {CROSS_LINKS.map((l) => (
              <Card
                ...
                interactive
                padding="sm"
                className="flex flex-col gap-1.5 hover:border-primary/30 hover:bg-surface-alt transition-colors"
                data-reveal
              >
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {CAPABILITIES.map((c) => (
              <div
                key={c.title}
                className="sharp-card border border-line p-6 flex flex-col gap-3"
                data-reveal
              >
                <div className="flex items-start justify-between">
                  <span className="text-primary/70">{c.icon}</span>
