      ...
      <section className="blueprint-grid pt-28 pb-20 border-b border-line">
        <div className="max-w-4xl mx-auto px-6" data-reveal>
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs text-primary font-mono">Platform Engineering</span>
          </div>
          ...
          <h1 className="text-4xl lg:text-5xl font-semibold text-ink leading-tight mb-5">
            Build the golden path.<br className="hidden md:block" /> Get out of the way.
          </h1>
      ...
      <section className="py-24 border-b border-line">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-12" data-reveal>
            ...
            <h2 className="text-2xl lg:text-3xl font-semibold text-ink">Everything your golden path needs.</h2>
          </div>
      ...
      <section className="py-20 border-b border-line bg-surface-alt/30">
        <div className="max-w-3xl mx-auto px-6">
          <div className="mb-8" data-reveal>
            <p className="text-xs font-mono tracking-widest uppercase text-primary mb-3">IaC native</p>
            <h2 className="text-2xl font-semibold text-ink mb-2">Register a service in your existing Terraform.</h2>
          </div>
          <div className="sharp-card border border-line overflow-hidden" data-reveal>
            ...
            <div className="p-5 font-mono text-sm leading-relaxed text-ink-secondary">
              <p><span className="text-primary">resource</span> <span className="text-ink">"deploytitan_service"</span> <span className="text-ink">"checkout"</span> {'{'}</p>
              <p className="ml-4">name         = <span className="text-signal-success">"checkout-api"</span></p>
              <p className="ml-4">environment  = <span className="text-signal-success">"production"</span></p>
              <p className="ml-4">tier         = <span className="text-signal-success">"critical"</span></p>
              <p className="ml-4 mt-2">deploy_policy {'{'}</p>
              <p className="ml-8">allowed_strategies = [<span className="text-signal-success">"canary"</span>, <span className="text-signal-success">"blue_green"</span>]</p>
              <p className="ml-8">max_risk_score     = <span className="text-primary">70</span></p>
              <p className="ml-8">auto_rollback      = <span className="text-primary">true</span></p>
              <p className="ml-4">{'}'}</p>
              <p>{'}'}</p>
            </div>
          </div>
