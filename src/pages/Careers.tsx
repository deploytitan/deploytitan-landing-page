...
const perks = [
  {
    ...
    description: 'Meaningful early-stage equity. We want you to benefit from the value you help create.',
  },
  {
    title: 'Remote-first',
    description: 'Work from wherever you do your best thinking. We overlap on Pacific time for core hours.',
  },
  {
...
export default function Careers() {
  useDocumentMeta('Careers', 'Join the team building DeployTitan — the deployment control plane for modern engineering teams.')
    ...
    <div className="min-h-screen bg-surface">
      ...
      <section className="border-b border-line blueprint-grid">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-16 lg:py-24">
          <div className="max-w-2xl">
            <span className="font-mono text-[11px] text-ink-quaternary uppercase tracking-widest">Careers</span>
            ...
            <p className="mt-5 text-lg text-ink-secondary leading-relaxed max-w-lg">
              We're a small, focused team working on a genuinely hard problem. Every engineer here has direct impact on the tooling that ships production software for thousands of teams.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-line bg-surface-alt">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-14">
          <span className="font-mono text-[10px] text-ink-quaternary uppercase tracking-widest">Benefits</span>
          <h2 className="mt-3 text-2xl font-display font-medium text-ink tracking-tight">What we offer</h2>
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {perks.map((p) => (
              <div key={p.title} className="sharp-card bg-surface p-6">
      ...
      <section className="max-w-[1400px] mx-auto px-6 lg:px-12 py-14">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            <span className="font-mono text-[10px] text-ink-quaternary uppercase tracking-widest">Open roles</span>
            <h2 className="mt-2 text-2xl font-display font-medium text-ink tracking-tight">
        ...
        <div className="flex flex-col divide-y divide-line">
          {filtered.map((job) => (
            <div key={job.id} className="py-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div>
        ...
        <div className="mt-10 pt-6 border-t border-line">
          <p className="text-sm text-ink-secondary">
            ...
            <a href="mailto:jobs@deploytitan.com" className="text-primary font-medium hover:text-primary-dark transition-colors">
