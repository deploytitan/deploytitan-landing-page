...
export const ContentOpportunityPipelineGuideInput = createContentPipelineGuideInput({
  ...
  defaultNextStep: 'Review the opportunity, set the KPI target, then create the article draft when accepted.',
  statusLabels: {
    ...
    briefCreated: 'Article Created',
  },
  statusToStageKey: {
    discovered: 'opportunity-discovery',
    reviewing: 'opportunity-discovery',
    accepted: 'article-materialization',
    rejected: 'opportunity-discovery',
    articleCreated: 'article-shaping',
    briefCreated: 'article-shaping',
  },
  statusNextStep: {
    discovered: 'Decide whether this opportunity is worth reviewing.',
    reviewing: 'Accept, reject, or clarify the opportunity before creating an article draft.',
    accepted: 'Run Create Article Draft to create the article and supporting evidence.',
    rejected: 'Leave rejected opportunities documented so future imports do not recreate duplicate work.',
    articleCreated: 'Open the linked article and shape it into a draft.',
    briefCreated: 'Open the linked article and shape it into a draft.',
  },
})
...
export const MarketQuestionPipelineGuideInput = createContentPipelineGuideInput({
  ...
  fallbackStageKey: 'article-shaping',
  defaultNextStep: 'Use this only when a question needs separate tracking outside an article.',
  statusLabels: {
  ...
  statusToStageKey: {
    unvalidated: 'article-materialization',
    validated: 'article-shaping',
    watching: 'article-shaping',
  },
})
...
export const ResearchEvidencePipelineGuideInput = createContentPipelineGuideInput({
  ...
  defaultNextStep: 'Classify visibility and link the evidence to the article only if it supports a real claim.',
})

export const ContentBriefPipelineGuideInput = createContentPipelineGuideInput({
  schemaType: 'contentBrief',
  title: 'Legacy brief guide',
  statusFallback: 'researching',
  fallbackStageKey: 'article-shaping',
  defaultNextStep: 'Legacy briefs are optional. Prefer shaping the article record directly.',
  statusLabels: {
    researching: 'Researching',
    briefReady: 'Ready to Draft',
    evidenceReviewed: 'Evidence Reviewed',
    drafting: 'Drafting',
    published: 'Published',
  },
  statusToStageKey: {
    researching: 'article-shaping',
...
export const ArticlePipelineGuideInput = createContentPipelineGuideInput({
  ...
  statusToStageKey: {
    ...
    published: 'distribution-and-measurement',
    needsRefresh: 'article-shaping',
  },
  statusNextStep: {
    idea: 'Attach or create the opportunity and article draft.',
    awaitingResearch: 'Curate public-safe evidence and finish the methodology note.',
    briefReady: 'Start drafting from the shaped article plan.',
    ...
    needsRefresh: 'Revisit the evidence, CTA, and search intent before redrafting.',
  },
})
